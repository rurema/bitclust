...
HERE
  ...
  sub_test_case 'newline characters truncation' do
    def params
      { 'version' => '2.4.0' }
    end

    def test_newline_between_ascii_character_and_ascii_character
      source = <<~SOURCE
        This is
        a pen.
      SOURCE
    ...
    def test_newline_between_ascii_character_and_non_ascii_character
      source = <<~SOURCE
        This is
        ペン。
      SOURCE
    ...
    def test_newline_between_non_ascii_character_and_ascii_character
      source = <<~SOURCE
        これは
        a pen.
      SOURCE
    ...
    def test_newline_between_non_ascii_character_and_non_ascii_character
      source = <<~SOURCE
        これは
        ペンです。
      SOURCE
